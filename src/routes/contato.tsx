...
export const Route = createFileRoute("/contato")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Fale com a Mimando pelo WhatsApp ou Instagram e encontre o presente perfeito.",
      },
...
function formatPhone(n: string) {
  // 5511984399180 -> +55 (11) 98439-9180
    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      <div className="text-center">
        ...
        <p className="mt-3 text-muted-foreground sm:text-lg">
          Fale com a Mimando e encontre o presente perfeito para cada momento.
        </p>
      </div>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <a
          ...
          className="group rounded-2xl bg-card p-6 shadow-card transition hover:-translate-y-0.5 hover:shadow-soft"
        >
        ...
        >
          ...
          <p className="mt-1 text-sm text-muted-foreground">@mimando.papelaria</p>
          <p className="mt-1 text-xs text-primary group-hover:underline">Ver perfil</p>
        </a>

        <div className="rounded-2xl bg-card p-6 shadow-card sm:col-span-2">
          <span className="grid h-10 w-10 place-items-center rounded-full bg-secondary text-primary">
